...
pdftitle={Prosjektskisse til stipendiatstilling},%
pdfsubject={Numerisk, ikkelineær fysikk},%
pdfkeywords={Numerisk fysikk, Ikkelineær dynamikk, Lagrange-koherente strukturer}%
}
...
% Use this package to adjust spacing in lists
\usepackage[]{enumitem}
